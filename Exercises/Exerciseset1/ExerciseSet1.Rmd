...
**Your Answers here:**
<br>1. Line 8 of dataSet1.R: "mytickers = c("SPY", "AAPL")"
<br>2. Cumulative returns: 574.8; average daily returns: 0.148; standard deviation: 2.425
<br>
<br>
...
**Your Answers here:**
<br>1. nrow(transposedData) and ncol(transposedData)
<br>2. Simply refer to a different part of the array/matrix by changing the [,1] to [1,]. i.e.: round(100*sum(StockReturns[1,]),1). Apply this to the previous lines finding daily returns. 
<br>
<br>
...
**Your Answers here:**
<br>1. Change the following line: startDate = "2001-01-01" (though it already appears to be getting data from 2001-01-01
<br>
<br>
<br>
...
**Your Answers here:**
<br>1. Each time a row in myData is not found in the StockReturns matrix, a 1 is produced. The final result is a sum of all 1s produced in the entire twentydays.csv file.
<br>
<br>
<br>
